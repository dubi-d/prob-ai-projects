...
class BayesianLayer(nn.Module):
    ...
    def __init__(self, in_features: int, out_features: int, bias: bool = True):
        ...
        self.weights_prior = MultivariateDiagonalGaussian(torch.ones(out_features, in_features),torch.ones(out_features, in_features))
        ...
        if self.use_bias:
            ...
            self.bias_prior = MultivariateDiagonalGaussian(torch.ones(out_features, in_features),torch.ones(out_features, in_features))
